...
const Step3Report = ({ report }) => {
  ...
  const downloadPDF = () => {
    ...
    if (finalScore >= 8) {
      advice =
        "Excellent performance. Maintain confidence and structure. Continue refining clarity and supporting answers with strong examples.";
    } else if (finalScore >= 5) {
      advice =
        "Good foundation shown. Improve clarity and structure. Practice delivering concise answers with strong examples.";
    } else {
      advice =
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-green-50 px-4 sm:px-6 lg:px-10 py-8">
      <div className="mb-8 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <button
          onClick={downloadPDF}
          className="bg-emerald-600 hover:bg-emerald-700 text-white px-6 py-3 rounded-xl shadow-md transition font-semibold text-sm sm:text-base"
        >
          Download PDF
        </button>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
        ...
        <div className="space-y-6">
          ...
          <motion.div className="bg-white rounded-3xl shadow-lg p-8 text-center">
          ...
          <motion.div className="bg-white rounded-3xl shadow-lg p-8">
